  ...
  return (
    <>
      ...
      <div className="midse">
        ...
        <br />
        <p>
          Our solution leverages Green Cart's existing infrastructure for
          recycling boxes from returned products. When enough customers choose
          the "return box" option and a specific region exceeds a set box
          threshold, scheduled pickups are arranged. Customers receive
          notifications via the app, website, or SMS/email. Pickup frequency
          varies by participation. Additionally, post-product delivery,
          customers can return packaging boxes, promoting sustainability in
          e-commerce.
        </p>
